...
class Thermistor:
    ...
    def __init__(self, r0, t0, beta, r1, r2):
        ...
        self.k = r0 * math.exp(-beta / self.t0)   # constant part of calculation
    ...
    def temp(self,adc):
        ...
        return (self.beta / math.log(abs(r / self.k))) - 273.15        # temperature

    def setting(self, t):
        """Convert a temperature into a ADC value"""
        r = self.r0 * math.exp(self.beta * (1 / (t + 273.15) - 1 / self.t0)) # resistance of the thermistor
